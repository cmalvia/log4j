...
There is an image [docker pull cmalvia/my-app:log4jv1](https://hub.docker.com/repository/docker/cmalvia/my-app) that you can get from Docker Hub which holds the code of this repository.
